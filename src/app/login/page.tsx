...
// Dual authentication page: Email/Password first, Magic Link second
...
type AuthTab = "password" | "magic"; // 👈 order flipped in type for clarity
...
export default function LoginPage() {
  ...
  // Tab and mode state
  const [activeTab, setActiveTab] = useState<AuthTab>("password"); // 👈 default now "password"
